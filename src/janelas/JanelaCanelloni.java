...
public class JanelaCanelloni extends JDialog {
	...
	public JanelaCanelloni(List<Massas> massas, Frame owner, String title) {
		super(owner, title);
		this.massas = massas;
		setSize(550, 375);
		setLayout(null);
	...
	private void componentes() {
		...
		jlTipoMassa = new JLabel("Canelloni");
	...
	private void eventos() {
		...
		jbSalvar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
					...
					new Canelloni(tipoMassa, saborMassa, peso, molho, tipoRecheio);					

					massas.add(new Canelloni(tipoMassa, saborMassa, peso, molho, tipoRecheio));
					dispose();
			}
		});
	}		
