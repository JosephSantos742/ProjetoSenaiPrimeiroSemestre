...
import classes.Rondelli;

public class JanelaRondelli extends JDialog {
	...
	private String [] tipoRecheio = {"Presunto e Queijo", "Ricota com Escarola"};
	...
	public JanelaRondelli(List<Massas> massas, Frame owner, String title) {
		super(owner, title);
		this.massas = massas;
		setSize(550, 375);
		setLayout(null);
	...
	private void componentes() {
		...
		jlTipoMassa = new JLabel("Rondelli");
	...
	private void eventos() {
		...
		jbSalvar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
					...
					new Rondelli(tipoMassa, saborMassa, peso, molho, tipoRecheio);					

					massas.add(new Rondelli(tipoMassa, saborMassa, peso, molho, tipoRecheio));
					dispose();
			}
		});
	}		
