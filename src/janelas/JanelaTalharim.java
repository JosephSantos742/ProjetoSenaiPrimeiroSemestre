...
import classes.Canelloni;
import classes.Massas;
import classes.Talharim;

public class JanelaTalharim extends JDialog {
	private Font fTitulo;
	private Color corFundo;
	private Icon iconSalvar, iconCancelar;
	private ImageIcon logo;
	private List<Massas> massas;
	private JLabel jlTipoMassa, jlSaborMassa, jlPeso, jlMolho, jlLogo;
	...
	private JComboBox<String> jcbSaborMassa, jcbPeso, jcbMolho;
	private JButton jbSalvar, jbCancelar;
	
	public JanelaTalharim(List<Massas> massas, Frame owner, String title) {
		super(owner, title);
		this.massas = massas;
		setSize(550, 375);
		setLayout(null);
	...
	private void componentes() {
		...
		jlTipoMassa = new JLabel("Talharim");
	...
	private void eventos() {
		...
		jbSalvar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
					...
					String tipoMassa, saborMassa, molho, peso;
					...
					new Talharim(tipoMassa, saborMassa, peso, molho);			

					massas.add(new Talharim(tipoMassa, saborMassa, peso, molho));
					dispose();
			}
		});
	}		
